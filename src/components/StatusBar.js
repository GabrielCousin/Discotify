    ...
    return (
      <div className={processedReleases ? 'Box' : 'Box Box--hidden' }>
        ...
        <div className="Box-AddOn">
          ...
          <button className="Button" type="button" onClick={this.handleSpotifyExport} disabled={!this.props.app.release_matching_done}>Export to Spotify</button>
          <a className="Button" href="https://open.spotify.com/collection/albums" target="_blank" rel="noopener noreferrer">All done! Go to Spotify</a>
        </div>
      </div>
    );
  }
